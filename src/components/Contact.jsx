...
export default function Contact() {
  ...
  return (
    ...
    >
      <div className="relative rounded-2xl sm:rounded-3xl border border-white/10 bg-neutral-950/80 p-6 sm:p-10 md:p-14 backdrop-blur-2xl overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.8)]">
        ...
        <div className="relative z-10 max-w-2xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-stretch sm:items-center gap-3 sm:gap-4 mt-6 sm:mt-8 w-full">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2.5 px-6 py-3 rounded-2xl bg-white/[0.04] border border-white/10 text-neutral-200 hover:bg-white/10 hover:border-white/20 transition-all font-medium text-xs sm:text-sm active:scale-95"
            >
              {copied ? (
                <>
          ...
          <form onSubmit={handleSubmit} className="mt-8 sm:mt-10 max-w-md mx-auto w-full">
            <div className="relative flex flex-col sm:flex-row items-stretch sm:items-center rounded-2xl border border-white/15 bg-white/[0.03] p-1.5 backdrop-blur-md focus-within:border-cyan-400/60 transition-colors gap-1.5 sm:gap-0">
              <div className="hidden sm:flex pl-3.5 text-neutral-500">
                <FiMail className="text-base" />
              </div>
              <input
                type="email"
              ...
              <button
                type="submit"
                className="inline-flex items-center justify-center gap-1.5 px-5 py-2.5 rounded-xl bg-white text-black font-semibold text-xs hover:bg-cyan-400 transition-all shadow-md flex-shrink-0 active:scale-95"
              >
                {submitted ? (
                  <>
