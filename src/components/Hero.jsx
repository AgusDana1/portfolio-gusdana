    ...
    >
      <div className="max-w-6xl w-full mx-auto grid lg:grid-cols-12 gap-10 lg:gap-8 items-center">
        ...
        >
          ...
          <div className="text-lg sm:text-2xl lg:text-3xl font-medium mt-3 text-neutral-300 font-mono flex items-center gap-2 min-h-[2rem] sm:min-h-[2.5rem]">
          ...
          <div className="flex items-center flex-wrap gap-2.5 sm:gap-3 mt-8 sm:mt-10">
            ...
            {[
              ...
              <a
                ...
                className="w-9 h-9 rounded-full border border-white/10 bg-white/[0.03] hover:bg-white/10 hover:border-cyan-400/50 hover:text-cyan-400 text-neutral-400 flex items-center justify-center transition-all duration-200 text-sm active:scale-90"
              >
                {social.icon}
              </a>
            ))}
        ...
        >
          ...
          <div className="relative rounded-2xl sm:rounded-3xl border border-white/15 bg-black/85 backdrop-blur-2xl shadow-2xl overflow-hidden w-full">
            ...
            {/* Code Body */}
            <div className="p-4 sm:p-5 font-mono text-[11px] sm:text-xs md:text-sm leading-relaxed overflow-x-auto text-neutral-300 max-w-full">
              {activeTab === "profile.json" ? (
                ...
                <pre className="overflow-x-auto">
                  <code>
                    ...
                    {"\n  "}frontend: [<span className="text-cyan-300">'React'</span>, <span className="text-cyan-300">'Tailwind'</span>],
                    {"\n  "}backend: [<span className="text-cyan-300">'Laravel'</span>, <span className="text-cyan-300">'Node.js'</span>],
                    {"\n  "}database: [<span className="text-cyan-300">'MySQL'</span>, <span className="text-cyan-300">'Postgres'</span>],
                    {"\n  "}architecture: <span className="text-green-300">'REST & Microservices'</span>
                    {"\n"}&#125;;
                  </code>
                </pre>
              )}
